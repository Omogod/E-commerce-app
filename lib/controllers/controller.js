...
exports.addProduct = (0, express_async_handler_1.default)(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        res.status(200).render('showProducts', { title: 'Products', data: allData, imageF, token, user: user.fullname, });
    });
});
...
exports.loginUser = (0, express_async_handler_1.default)(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const valid = yield (0, inputValidators_1.validateUserLoginDetails)(email, password, repeat_password);
        if (valid) {
